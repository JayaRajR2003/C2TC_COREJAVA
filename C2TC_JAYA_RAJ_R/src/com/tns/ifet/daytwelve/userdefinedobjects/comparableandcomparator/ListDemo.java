...
package com.tns.ifet.daytwelve.userdefinedobjects.comparableandcomparator;
...
class Point implements Comparable<Point> 
{
    ...
    public int compareTo(Point p) {
        // Sort by x-coordinate primarily, and by y-coordinate if x-coordinates are equal
        int compareX = Float.compare(this.x, p.x);
        return compareX != 0 ? compareX : Float.compare(this.y, p.y);
    }
